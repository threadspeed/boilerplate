---
title: python script base (snippet)
date: 2020-03-03
tags: ["python"]
---
Python script 'base'
...
class BasicOperator(object):
    def __init__(self, func, intypes, outtype, import_code, callable_code):
        self.func          = func
...
class LearnerOperator(BasicOperator):
    def __init__(self, *args, **kargs):
        ...
        self.func = self._train_model_and_predict(self, input_df, model=self.func, **kwargs)
    def callable_code(self, operator_num, operator):
