---
title: python script 100 http exporter (snippet)
date: 2020-03-03
tags: ["python"]
---
Python script '100 http exporter'
...
if __name__ == "__main__":
   ...
   if len(sys.argv)==2:
     try:
        os.system("ps -ef | grep simple_http_thread.py  | grep -v grep |awk  '{print($2}' | xargs kill -9"))
