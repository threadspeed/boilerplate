---
title: python script spectral xmeans demos v2 (snippet)
date: 2020-03-03
tags: ["python"]
---
Python script 'spectral xmeans demos v2'
...
# Programmer : zhuxp
# Date: 
# Last-modified: 01-09-2015, 12:14:40 EST
import sys
...
def test():
    ...
    for i in xrange(k):
        ...
        gdist.append((s*random.random(),s*random.random()))
    ...
    rank=range(0,l)
    mu,alpha,dist,idx=xmeans(vector,50)
    xmu,xalpha,xdist,xidx=xmeans(b,50)
    ...
    axarr[1,2].scatter(vector.T[3],vector.T[4],c=idx)
    plt.show()
