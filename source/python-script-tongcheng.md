---
title: python script tongcheng (snippet)
date: 2020-03-03
tags: ["python"]
---
Python script 'tongcheng'
...
url = 'https://www.ly.com/scenery/scenerysearchlist_0_0__0__0_0_0_0_0.html'
...
for i in all_href:
    ...
    dict_2['scenic'] = strip(hmtl_1.xpath("//h3[@class='s_name']/text()")[0])#景点
    dict_2['star_level'] = strip(hmtl_1.xpath('//*[@id="content"]/div[3]/div[2]/h3/span/text()')[0])#星级
    ...
    # img = hmtl_1.xpath('//*[@id="img_s_ul"]//@src')#相关图片
