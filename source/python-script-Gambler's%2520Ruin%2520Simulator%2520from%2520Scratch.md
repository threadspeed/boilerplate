---
title: python script Gambler's%2520Ruin%2520Simulator%2520from%2520Scratch (snippet)
date: 2020-03-03
tags: ["python"]
---
Python script 'Gambler's%2520Ruin%2520Simulator%2520from%2520Scratch'
...
def gambling():
    ...
    #print(roulette)
    #print(roulette.count(0), roulette.count(1))
    ...
    for _ in range(simulating_count):
        ...
        while(A>0 and B>0): # Play the game until someone is bankrupt.
            ...
            if random.choice(roulette) == 0: # gambler wins the single game.
                A += 1
                B -= 1
                #gambling_count += 1
            ...
            elif random.choice(roulette) == 1: # casino wins the single game.
                A -= 1
                B += 1
                #gambling_count += 1
        ...
        if A == 0:
            win_count_casino += 1
            #print('---------------------')
            #print('casino wins the game')
        elif B == 0:
            win_count_gambler += 1
            #print('----------------------')
            #print('gambler wins the game')
